...
angular.module("Creative",["ngRoute","ngAnimate","ngResource","ngFileUpload","ui.bootstrap","textAngular","angular-loading-bar"]).config(["$sceDelegateProvider","$routeProvider","$provide",function(e,t,r){e.resourceUrlWhitelist(["self","*://www.youtube.com/**"]),t.when("/",{templateUrl:"templates/admin/FileEntryView.html",controller:"FileEntryController"}).when("/fileentry/:type?",{templateUrl:"templates/admin/FileEntryView.html",controller:"FileEntryController"}).when("/files/add",{templateUrl:"templates/admin/FileEntryForm.html",controller:"AddFileController"}).when("/files/edit/:id",{templateUrl:"templates/admin/FileEntryForm.html",controller:"EditFileController"}).when("/teachers",{templateUrl:"templates/admin/TeachersView.html",controller:"TeacherController"}).when("/teachers/add",{templateUrl:"templates/admin/TeacherForm.html",controller:"AddTeacherController"}).when("/teachers/edit/:id",{templateUrl:"templates/admin/TeacherForm.html",controller:"EditTeacherController"}).when("/exams",{templateUrl:"templates/admin/ExamView.html",controller:"ExamController"}).when("/exams/add",{templateUrl:"templates/admin/AddExamForm.html",controller:"AddExamController"}).when("/exams/:id/results",{templateUrl:"templates/admin/ResultView.html",controller:"ResultController"}).when("/admissions",{templateUrl:"templates/admin/AdmissionView.html",controller:"AdmissionController"}).when("/admissions/:id",{templateUrl:"templates/admin/AdmissionForm.html",controller:"EditAdmissionController"}).when("/posts",{templateUrl:"templates/admin/BlogPostView.html",controller:"BlogPostController"}).when("/posts/add/",{templateUrl:"templates/admin/BlogPostForm.html",controller:"AddBlogPostController"}).when("/posts/edit/:id",{templateUrl:"templates/admin/BlogPostForm.html",controller:"EditBlogPostController"}).when("/settings/",{templateUrl:"templates/admin/Settings.html",controller:"SettingsController"}).otherwise({redirectTo:"/"}),r.decorator("taOptions",["$delegate",function(e){return e.toolbar=[["bold","italics","underline","justifyLeft","justifyCenter","justifyRight"],["ul","ol","p","quote","redo","undo"],["h1","h2","h3","insertLink","insertImage","insertVideo"],["wordcount","charcount"]],e}])}]).factory("File",["$resource",function(e){return e("api/files/:id",{id:"@id"},{query:{isArray:!1},update:{method:"PUT"},changeVisibility:{url:"api/files/changevisibility/:id",method:"POST"}})}]).factory("Exam",["$resource",function(e){return e("api/exams/:id",{id:"@id"},{query:{isArray:!1},update:{method:"PUT"}})}]).factory("Result",["$resource",function(e){return e("api/exams/:examId/results/:resultId",{examId:"@id",resultId:"@id"},{update:{method:"PUT"}})}]).factory("Teacher",["$resource",function(e){return e("api/teachers/:id",{id:"@id"},{update:{method:"PUT"}})}]).factory("Admission",["$resource",function(e){return e("api/admissions/:id",{id:"@id"},{update:{method:"PUT"}})}]).factory("BlogPost",["$resource",function(e){return e("api/posts/:id",{id:"@id"},{query:{isArray:!1},update:{method:"PUT"}})}]).factory("BlogComment",["$resource",function(e){return e("api/posts/:postId/comments/:commentId",{postId:"@id",id:"@commentId"},{query:{isArray:!1},update:{method:"PUT"}})}]).factory("BlogCategory",["$resource",function(e){return e("categories/:id",{id:"@id"})}]).factory("Util",[function(){return{getFileType:function(e){var t=/[^.]+$/.exec(e)[0].toLowerCase();switch(t){case"jpg":case"png":case"gif":return"image";case"doc":case"docx":return"document";case"ppt":case"pptx":case"pps":case"ppsx":return"presentation";case"pdf":return"ebook"}}}}]).controller("MainController",["$scope",function(e){e.$on("$routeChangeStart",function(){e.loadingIcon=!0}),e.$on("$routeChangeSuccess",function(){e.loadingIcon=!1})}]).controller("FileEntryController",["$rootScope","$scope","$routeParams","$modal","File",function(e,t,r,o,n){var i=r.type;t.pageTitle=i?i:"Overview",e.current=t.pageTitle.toLowerCase(),void 0==localStorage.config?(t.config={orderBy:"created_at",isReverse:!0},localStorage.config=angular.toJson(t.config)):t.config=angular.fromJson(localStorage.config),t.pagination={page:1,itemPerPage:8,type:i?i.substr(0,i.length-1):"",orderBy:t.config.orderBy,isReverse:t.config.isReverse,total:1},t.setPage=function(){t.loadPage()},t.loadPage=function(){n.query(t.pagination,function(e){t.fileEntries=e.data,t.pagination.total=e.total;for(var r=0;r<t.fileEntries.length;r++)"image"!=t.fileEntries[r].type&&"video"!=t.fileEntries[r].type&&(t.fileEntries[r].link="")})},t.loadPage(),t.selected=[],t.selectedCount,t.select=function(e){t.isSelected(e)?t.selected.splice(t.selected.indexOf(e),1):t.selected.push(e),t.selectedCount=t.selected.length},t.isSelected=function(e){return t.selected.indexOf(e)>-1},t.open=function(e,r,n){if("image"==t.fileEntries[e].type||"video"==t.fileEntries[e].type){{o.open({templateUrl:"../templates/ImageViewer.html",controller:"ImageViewerController",size:n,resolve:{info:function(){return{fileEntries:t.fileEntries,index:e,id:r}}}})}setTimeout(function(){document.getElementById("imageViewer").focus()},100)}}}]).controller("AddFileController",["$scope","$resource","$location","$timeout","Upload","File","Util",function(e,t,r,o,n,i,l){e.fileEntry={},e.fileEntry.isVisible=!0;var a;e.upload=function(t){return e.errors=void 0,a=t[0],void 0!=a?(e.fileEntry.thumbnail=void 0,s(),void 0==e.fileEntry.type?void(e.errors={file:["Invalid file type! Only image, word, powerpoint & pdf files are supported."]}):a.size>2097152&&"image"==e.fileEntry.type?void(e.errors={file:["The image file may not be greater than 2 MB."]}):void n.upload({url:"files/upload",file:a}).success(function(t){e.fileEntry.thumbnail=t}).error(function(t){e.errors=t})):void 0},e.save=function(){"video"!=e.fileEntry.type&&a&&(e.fileEntry.fileName=a.name),i.save(e.fileEntry,function(){r.path("/").replace()},function(t){e.errors=t.data})},e.loadThumbnail=function(){e.fileEntry.type=e.fileEntry.type=e.fileEntry.link.length>0?"video":void 0,e.fileEntry.thumbnail="http://img.youtube.com/vi/"+e.fileEntry.link+"/mqdefault.jpg",e.fileEntry.created_at=new Date},e.changevisibility=function(){e.fileEntry.isVisible=!e.fileEntry.isVisible};var s=function(){e.fileEntry.type=l.getFileType(a.name),e.fileEntry.created_at=new Date,e.fileEntry.size=a.size}}]).controller("EditFileController",["$scope","$routeParams","$location","Upload","File",function(e,t,r,o,n){var i=t.id;e.editMode=!0,e.fileEntry=n.get({id:i},function(t){e.fileEntry.thumbnail="http://img.youtube.com/vi/"+t.link+"/mqdefault.jpg"}),e.changevisibility=function(){e.fileEntry.isVisible=!e.fileEntry.isVisible},e.save=function(){e.fileEntry.$update({id:i}),r.path("/").replace()}}]).controller("ImageViewerController",["$scope","$modalInstance","info",function(e,t,r){e.fileEntry=r.fileEntries.filter(function(e){return e.id==r.id})[0],e.next=function(){r.index=(r.index+1)%r.fileEntries.length,e.fileEntry=r.fileEntries[r.index],"image"!=e.fileEntry.type&&"video"!=e.fileEntry.type&&e.next()},e.prev=function(){r.index=0==r.index?r.fileEntries.length-1:r.index-1,e.fileEntry=r.fileEntries[r.index],"image"!=e.fileEntry.type&&"video"!=e.fileEntry.type&&e.prev()},e.controls=function(t){37==t.keyCode?e.prev():39==t.keyCode&&e.next()}}]).controller("ButtonBarController",["$scope","$filter","$resource","$location","File",function(e,t,r,o,n){e.gotoEdit=function(){if(1==e.selected.length){var t=e.selected[0],r=e.fileEntries[t].id;o.url("/files/edit/"+r)}},e.changeVisibility=function(){for(var t=0;t<e.selected.length;t++){var r=e.selected[t],o=e.fileEntries[r].id;e.fileEntries[r].isVisible=!e.fileEntries[r].isVisible,n.changeVisibility({id:o})}e.$parent.selected=[],e.$parent.selectedCount=0},e["delete"]=function(){e.selected.sort(function(e,t){return e-t});for(var t=e.selected.length-1;t>=0;t--){var r=e.fileEntries[e.selected[t]].id;n["delete"]({id:r}),e.$parent.fileEntries.splice(e.selected[t],1)}e.$parent.selected=[],e.$parent.selectedCount=0},e.setOrderBy=function(t){t==e.config.orderBy&&(e.config.isReverse=!e.config.isReverse),e.config.orderBy=t,e.pagination.orderBy=e.config.orderBy,e.pagination.isReverse=e.config.isReverse,localStorage.config=angular.toJson(e.config),e.loadPage()}}]).controller("TeacherController",["$rootScope","$scope","$resource","Teacher","Teacher",function(e,t,r,o,o){e.current="teacher",t.teachers=o.query(),t["delete"]=function(e){var r=t.teachers[e].id;o["delete"]({id:r}),t.teachers.splice(e,1)}}]).controller("AddTeacherController",["$rootScope","$scope","$resource","$location","Upload","Teacher",function(e,t,r,o,n,i){e.current="teacher";var l;t.teacher={},t.upload=function(e){return t.errors=void 0,l=e[0],void 0!=l?"jpg"!=/[^.]+$/.exec(l.name)[0].toLowerCase()?void(t.errors={file:["Invalid image type! Only jpg image is supported."]}):l.size>2097152?void(t.errors={file:["The image file may not be greater than 2 MB."]}):void n.upload({url:"files/upload",file:l}).success(function(e){t.teacher.image=e}).error(function(e){t.errors=e.data}):void 0},t.save=function(){l&&(t.teacher.fileName=l.name),i.save(t.teacher,function(){o.path("/teachers").replace()},function(e){t.errors=e.data})}}]).controller("EditTeacherController",["$scope","$resource","$routeParams","$location","Teacher","Upload",function(e,t,r,o,n,i){var l=r.id;e.teacher=n.get({id:l}),e.upload=function(t){return e.errors=void 0,file=t[0],void 0!=file?"jpg"!=/[^.]+$/.exec(file.name)[0].toLowerCase()?void(e.errors={file:["Invalid image type! Only jpg image is supported."]}):file.size>2097152?void(e.errors={file:["The image file may not be greater than 2 MB."]}):void i.upload({url:"files/upload",file:file}).success(function(t){e.teacher.image=t}).error(function(t){e.errors=t.data}):void 0},e.save=function(){file&&(e.teacher.fileName=file.name),e.teacher.$update({id:l},function(){o.path("/teachers").replace()},function(t){e.errors=t.data})}}]).controller("ExamController",["$rootScope","$scope","Exam",function(e,t,r){e.current="result",t.pagination={page:1,itemPerPage:10,total:1},t.setPage=function(){o()};var o=function(){t.exams=r.query(t.pagination,function(e){t.exams=e.data,t.pagination.total=e.total})};o(),t["delete"]=function(e){r["delete"]({id:t.exams[e].id}),t.exams.splice(e,1)}}]).controller("AddExamController",["$rootScope","$scope","$location","Exam","BlogCategory","Util",function(e,t,r,o,n){e.current="result",t.subjects=n.query(),t.open=function(e){e.preventDefault(),e.stopPropagation(),t.opened=!0},t.save=function(){var e=o.save(t.exam,function(){r.path("/exams/"+e.id+"/results").replace()},function(e){t.errors=e.data})}}]).controller("ResultController",["$rootScope","$scope","$timeout","$routeParams","$location","$filter","Exam","Result","Util",function(e,t,r,o,n,i,l,a){$(".showForPrint").hide(),e.current="result",t.examId=o.id,t.exam=l.get({id:t.examId},function(e){t.exam.date=new Date(Date.parse(e.date))}),t.results=a.query({examId:t.examId}),t.rollMatch=!1,t.editMode=-1,t.sortBy="sroll",t.isReverse=!1,t.create=function(){t.errors=void 0;var e=t.results.filter(function(e){return e.sroll==t.student.sroll});e.length>0?t.errors={sroll:["A student with the same roll is already inserted."]}:t.student.mark>t.exam.mark_range?t.errors={mark:["A student's mark can not be greater than mark range."]}:t.student=a.save({examId:t.examId},t.student,function(){t.results.push(t.student)},function(e){t.errors=e.data})},t.updateResult=function(e){t.editMode=-1;var r=t.results[e].id;t.results[e].$update({examId:t.examId,resultId:r})},t["delete"]=function(e){a["delete"]({examId:t.examId,resultId:t.results[e].id}),t.results.splice(e,1)},t.updateExam=function(){t.exam.$update({id:t.examId}),n.path("/exams")},t.enableEdit=function(e){var r=t.results[e].id;t.results[e]=a.get({examId:t.examId,resultId:r}),t.editMode=e},t.print=function(){$(".hideForPrint").hide(),$(".showForPrint").show(),window.print(),$(".hideForPrint").show(),$(".showForPrint").hide()},t.sort=function(e){e==t.sortBy&&(t.isReverse=!t.isReverse),t.results=i("orderBy")(t.results,e,t.isReverse),t.sortBy=e}}]).controller("AdmissionController",["$rootScope","$scope","Admission",function(e,t,r){e.current="admissions",t.admissions=r.query(),t.destroy=function(e){r["delete"]({id:t.admissions[e].id}),t.admissions.splice(e,1)}}]).controller("EditAdmissionController",["$rootScope","$scope","$routeParams","$location","Admission","Upload",function(e,t,r,o,n,i){$(".showForPrint").hide(),e.current="admissions",t.student=n.get({id:r.id},function(){t.student.date_of_birth=new Date(Date.parse(t.student.date_of_birth))});var l;t.upload=function(e){return t.errors=void 0,l=e[0],void 0!=l?"jpg"!=/[^.]+$/.exec(l.name)[0].toLowerCase()?void(t.errors={file:["Invalid image type! Only jpg image is supported."]}):l.size>2097152?void(t.errors={file:["The image file may not be greater than 2 MB."]}):void i.upload({url:"files/upload",file:l}).success(function(e){t.student.image=e}).error(function(e){t.errors=e.data}):void 0},t.update=function(){l&&(t.student.fileName=l.name),t.student.$update({id:r.id},function(){o.path("/admissions").replace()},function(e){t.errors=e.data})},t.print=function(){$(".hideForPrint").hide(),$(".showForPrint").show(),window.print(),$(".hideForPrint").show(),$(".showForPrint").hide()}}]).controller("BlogPostController",["$rootScope","$scope","BlogPost",function(e,t,r){e.current="blog",t.pagination={page:1,itemPerPage:10,total:1},t.setPage=function(){o()};var o=function(){t.posts=r.query(t.pagination,function(e){t.posts=e.data,t.pagination.total=e.total})};o(),t.destroy=function(e){r["delete"]({id:t.posts[e].id}),t.posts.splice(e,1)}}]).controller("AddBlogPostController",["$rootScope","$scope","$location","BlogPost","BlogCategory","Teacher",function(e,t,r,o,n,i){e.current="blog",t.addMode=!0,t.post={},t.authors=i.query(),t.categories=n.query(),t.save=function(){t.errors=void 0,o.save(t.post,function(){r.path("/posts").replace()},function(e){t.errors=e.data})}}]).controller("EditBlogPostController",["$rootScope","$scope","$routeParams","$location","BlogPost","BlogComment","BlogCategory","Teacher",function(e,t,r,o,n,i,l,a){var s=r.id;e.current="blog",t.post=n.get({id:s}),t.authors=a.query(),t.isCollapsed=!0,t.categories=l.query(),t.save=function(){t.post.$update({id:s}),o.path("/posts").replace()},t.comments={},t.pagination={page:1,itemPerPage:5,total:1},t.setPage=function(){t.showComments()},t.showComments=function(){t.comments=i.query({postId:s,page:t.pagination.page,itemPerPage:t.pagination.itemPerPage},function(e){t.comments=e.data,t.pagination.total=e.total,t.isCollapsed=!1}),$(".panel-body").slideDown()},t.deleteComment=function(e){i["delete"]({postId:s,commentId:t.comments[e].id}),t.comments.splice(e,1)}}]).controller("SettingsController",["$rootScope","$scope","$http",function(e,t,r){e.current="settings",t.newPass="",r.get("api/admin/getinfo").success(function(e){t.info=e}),t.update=function(){t.errors=void 0,r.post("api/admin/update",t.admin).success(function(e){"false"==e?t.errors={old_password:["The old password doesn't match our record!"]}:t.success="Password changed successfully!"}).error(function(e){t.errors=e})},t.changeFilePassword=function(){r.get("api/admin/changefilepassword/"+t.newPass).success(function(e){t.info.filepass=e})},t.clearTemp=function(){r.get("api/admin/cleartemp").success(function(e){t.info.tempsize=e})}}]).directive("error",function(){return{restrict:"E",scope:{errors:"="},templateUrl:"Errors.html"}}).filter("ago",function(){return function(e){for(var t=(new Date-new Date(e))/1e3,r=[60,60,24,30,12],o=[" second"," minute"," hour"," day"," month"," year"],n=0;Math.floor(t/r[n])>0;n++)t/=r[n];var i=Math.floor(t)>1?"s":"";return Math.floor(t)+o[n]+i+" ago"}}).filter("fixdate",function(){return function(e){return new Date(Date.parse(e))}}).filter("gp",function(){return function(e,t){return t=t?t:100,e=100*e/t,e>=0&&33>e?0:e>=33&&40>e?1:e>=40&&50>e?2:e>=50&&60>e?3:e>=60&&70>e?3.5:e>=70&&80>e?4:e>=80&&101>e?5:void 0}}).filter("size",function(){return function(e){return 1024>e?e:e>=1024&&1048576>=e?e/1024:e>=1048576?e/1048576:void 0}}).filter("sizeType",function(){return function(e){var t;return 1024>e&&(t="B"),e>=1024&&1048576>e&&(t="KB"),e>=1048576&&1073741824>e&&(t="MB"),e>=1073741824&&(t="GB"),t}}).filter("thumbnail",function(){return function(e){return""!=e?e.match(/^fileStorage/)?e+"t.jpg":"http://img.youtube.com/vi/"+e+"/mqdefault.jpg":void 0}}).filter("videolink",function(){return function(e){return"//www.youtube.com/embed/"+e}}).filter("icon",function(){return function(e){switch(e){case"document":return"word";case"spreadsheet":return"excel";case"presentation":return"powerpoint";case"ebook":return"ebook"}}}).filter("phone",function(){return function(e){return"+880 "+e}}).filter("class",function(){return function(e){var t=["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"];return t[e-1]}}),$(document).ready(function(){$(".navbar-toggle").on("click",function(){$(".sidebar aside").animate({width:"toggle"},250)}),window.innerHeight<500&&$(".storage").hide()});