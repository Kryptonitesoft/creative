...
$(document).ready(function(){$(window).scroll(function(){var s=$(this).scrollTop();return 100>=s&&($("body").removeClass("scroll"),$("nav[role=primary]").removeClass("scroll")),s>=100&&($("body").addClass("scroll"),$("nav[role=primary]").addClass("scroll")),window.innerWidth<1200?($(".img").removeClass("scroll"),$(".features section").removeClass("scroll"),$(".teaching-process img").removeClass("scroll"),$(".teaching-process h2").addClass("rotateX"),$(".teaching-process p").addClass("rotateX"),void $(".teaching-process li").addClass("rotateX")):(s>=100&&$(".whatis").addClass("animated zoomIn"),s>=150&&$(".teachers figure").addClass("animated zoomIn"),s>=300&&$(".features h2").addClass("animated zoomIn"),s>=500&&($(".img").removeClass("scroll"),$(".features section").removeClass("scroll")),s>=1e3&&$(".teaching-process h2").addClass("rotateX"),s>=1100&&$(".teaching-process p").addClass("rotateX"),s>=1150&&$(".teaching-process li").addClass("rotateX"),s>=1150&&$(".teaching-process img").removeClass("scroll"),s>=1200&&$(".teaching-process .btn").addClass("animated zoomIn"),s>=1500&&$(".social a").addClass("animated zoomIn"),void(s>=1e3&&$(".packages section").addClass("animated zoomIn")))})});